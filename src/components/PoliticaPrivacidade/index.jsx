...
export default function PoliticaPrivacidade() {
    return (
      <>
        <section className="term-of-polity">
        <div className="container-site">
            <div className="term-polity">
                <div className="router"><Link href="./" alt="Home">Home</Link> &gt; Política de Privacidade</div>
                <h4>POLÍTICA DA PRIVACIDADE</h4>
